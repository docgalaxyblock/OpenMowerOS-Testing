...
Do not use Wordpad for editing files here, it will mangle them and your
configuration won't work. Use a proper text editor instead.

!!!!! HEADS-UP MacOS USERS !!!!!
---------------------------------

If you use Textedit to edit the files make sure to use "plain text format"
